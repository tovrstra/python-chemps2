...
Ham = ReadinHamiltonianPsi4.Read('matrixelements/N2_N14_S0_d2h_I0.dat')
...
OK0 = (np.fabs(Energy0 + 107.648250974014) < 1e-10)
OK1 = (np.fabs(Energy1 + 106.944757308768) < 1e-10)
OK2 = (np.fabs(Energy2 + 106.92314213886 ) < 1e-10)
